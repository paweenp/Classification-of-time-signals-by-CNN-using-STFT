...
\begin{figure}[htbp]
\centerline{\includegraphics[scale = 0.32]{flowchart_2.png}}
...
%  \textbf{Layer} & \textbf{Description} & \textbf{Size} \\
%\hline
%'imageinput'    & Image Input & 132×175×3 images with %'zerocenter' normalization  \\
%\end{tabularx}
